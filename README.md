...
- **[`django`](./django/README.md)**: Build a Django REST API backend quickly with SQLite for rapid hackathon development.
- **[`databases`](./databases/README.md)**: Understand database paradigms and choose between relational, document, and graph databases.
