...
```
Verify installation by running `python3 --version` and `pip3 --version` (should show Python 3.x).

2.	Create a virtual environment. This keeps project dependencies isolated. From your project folder, run:
```bash
    python3 -m venv venv
    # Activate it:
    # Windows: 
...
```
1. Install Django and DRF. With Python ready, install the required packages via pip:
```bash
